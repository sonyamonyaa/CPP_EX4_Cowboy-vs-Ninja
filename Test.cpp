...
TEST_CASE("Test 2 - Character Functions")
{
    ...
    Cowboy *cb = new Cowboy("Billy", point_cowboy);
    YoungNinja *yn = new YoungNinja("Youngin", point_ninja_yng);
    TrainedNinja *tn = new TrainedNinja("Tony", point_ninja_tra);
    OldNinja *old = new OldNinja("Sensei", point_ninja_old);
